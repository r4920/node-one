...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Stacy_Kshlerin',
      password: 'xCADSXta6gyzRLp',
      email: 'Matteo_Little37@hotmail.com',
      name: 'Cesar Bruen',
      mobileNo: '808.235.4271 x2461',
      userType: 585,
      resetPasswordLink: {},
      loginRetryLimit: 57,
      loginReactiveTime: '2023-01-29T10:44:34.451Z',
      id: '622839d6fde1821f882c7c79'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Alan56',
        'password':'mkL6QPWa41ikGu1',
        'email':'Marlin.Daniel@yahoo.com',
        'name':'Ms. Otis Steuber',
        'mobileNo':'(323) 429-9373 x8852',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Marlin.Daniel@yahoo.com', });
